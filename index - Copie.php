                ...
                <div class="row alert alert-light">
                  <table class="table table-border table-responsive">
                    <tbody>
                        ...
                        <tr>
                            <td>Impression</td><td><span id="type_imp"></span> | <span id="prix_imp"></span></td>
                        </tr> 
                        <tr>
                            <td>Nombre de modèle Quadri</td><td><div id="type_quadri"></div></td>
                        </tr> 
                        <tr>
                            <td>Zone écriture 1 face</td><td><span id="type_zone"></span> | <span id="prix_zone"></span></td>
                        </tr> 
                        <tr>
                            <td>Overlay 1 face</td><td><span id="type_over"></span> | <span id="prix_over"></span></td>
                        </tr> 
                        <tr>
                            <td>Numérotation</td><td><span id="type_num"></span> | <span id="numdebu"></span></td>
                        </tr> 
                        <tr>
                            <td>Code barre</td><td><span id="type_barre"></span> | <span id="prix_code"></span></td>
                        </tr> 
                        <tr>
                            <td>Qr code</td><td><span id="type_qr"></span> | <span id="prix_qr"></span></td>
                        </tr> 
                        <tr>
                            <td>Personnalisation</td><td><span id="type_nom"></span> | <span id="prix_nom"></span></td>
                        </tr> 
                        <tr>
                            <td>Infographie</td><td><span id="type_info"></span> | <span id="prix_info"></span></td>
                        </tr> 
                        <tr>
                          <td></td>
                          <td></td>
